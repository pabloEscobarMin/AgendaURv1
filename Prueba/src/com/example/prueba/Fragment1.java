...
public class Fragment1 extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		selectedDayMonthYearButton = (Button) this.getActivity().findViewById(R.id.selectedDayMonthYear);
		selectedDayMonthYearButton.setText("Selected: ");

		prevMonth = (ImageView) this.getView().findViewById(R.id.prevMonth);
		prevMonth.setOnClickListener(this.getActivity());
		...
		nextMonth.setOnClickListener(this.getActivity());

		calendarView = (GridView) this.getView().findViewById(R.id.calendar);

		// Initialised
		adapter = new GridCellAdapter(this.getActivity().getApplicationContext(),
